const data = {"page":9,"pageLabel":"第09页","title":"3+1 AI 原生审计技术底座","columns":[["","“3”：三类底座能力平台","","智能体平台：AI 能力生产与编排底座","统一承载模型、知识库、数据库连接、MCP 工具、智能问数、法规问答、文档抽取和智能体编排能力。","","数据治理平台：复杂数据可用性治理底座","围绕结构化数据库和非结构化资料，完成数据探查、数据漫游、实体识别、结构化抽取和结果沉淀。","","数据图谱平台：关系资产化与线索挖掘底座","承接治理形成的实体、关系和线索结果，完成图谱建模、关系穿透、路径追溯、图计算和 AI 推理。","","“1”：一个综合作业平台","","综合分析平台：审计任务执行与能力沉淀平台","聚合结构化数据、图谱关系、知识库、文档资料、审计技能和智能体能力，支撑项目作业、报告生成和能力复用。","",""]],"fontSize":18.5};
