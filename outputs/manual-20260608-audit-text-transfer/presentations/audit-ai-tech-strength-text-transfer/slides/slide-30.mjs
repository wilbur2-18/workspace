const data = {"page":30,"pageLabel":"第30页","title":"多源数据融合与统一资源接入","columns":[["","多源数据融合与统一资源接入","","文档智能处理","","• 支持 PDF、Word、Excel 等格式上传与结构化解析。","• 支持非标准文档格式转换。","• 支持文档资料中的实体、金额、日期、合同、项目等要素抽取。","","多源资源接入","","在同一项目工作空间中统一接入：","","• 文档资料","• 结构化数据库","• 数据图谱"],["• 知识库","• 审计技能","","多源融合分析","","• 单界面集成文档线索、数据库记录和图谱关联关系。","• 支持文档 → 数据 → 图谱自动联动。","• 支持将抽取结果、查询结果和图谱路径组合为分析依据。","","定性支持能力","","同步匹配本地部署的审计案例知识库和法律法规知识库，为 AI 生成的疑点匹配法规依据。","",""]],"fontSize":15};
