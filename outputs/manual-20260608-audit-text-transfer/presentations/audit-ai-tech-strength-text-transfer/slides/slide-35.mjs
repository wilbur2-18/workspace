const data = {"page":35,"pageLabel":"第35页","title":"审计案例：投资审计","columns":[["","审计案例：投资审计","","审计场景","","投资审计涉及立项、决策、合同、付款、投后管理、收益测算等大量资料，人工审阅成本高。","","传统痛点","","• 审计人员需要在大量投资项目资料中反复查找关键信息。","• 需要核对决策程序、投资依据、合同条款、收益测算和投后管理。","• 资料类型多、口径复杂、人工比对耗时。","• 项目初筛阶段难以快速形成统一判断。","","AI 做法",""],["基于沉淀的投资审计技能，大模型可围绕指定项目自动执行：","","• 读取项目资料","• 抽取关键要素","• 识别立项与决策过程","• 匹配审计规则","• 比对合同、付款和收益测算信息","• 提示疑点线索","• 生成初步分析结果和复核清单","","应用成效","","基于沉淀的技能，约 3 分钟跑出分析结果，帮助审计人员形成项目初步判断。","",""]],"fontSize":15};
