const data = {"page":2,"pageLabel":"第02页","title":"目录","columns":[["","01 审计智能化演进与关键问题","02 AI 原生产品底座与能力链路","03 智能体平台：AI 能力生产与编排底座","04 数据治理平台：复杂数据可用性治理","05 数据图谱平台：关系建模、图计算与线索挖掘","06 综合分析平台：任务执行、技能沉淀与应用承接","07 总结：从单点能力到 AI 原生审计闭环","",""]],"fontSize":18.5};
