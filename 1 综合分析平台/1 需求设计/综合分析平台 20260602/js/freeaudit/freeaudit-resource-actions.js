  ...
  NS.actionGroups.resourceActions = {
        ...
        initFromUrl() {
          ...
          this.dbResourceList = projectUsesEmptyWorkbenchResourceSeeds(nextProjectId)
            ? []
            : cloneRows(typeof DEMO_WORKBENCH_DB_RESOURCE_LIST !== 'undefined' ? DEMO_WORKBENCH_DB_RESOURCE_LIST : []);
          this.graphResourceList = projectUsesEmptyWorkbenchResourceSeeds(nextProjectId)
            ? []
            : cloneRows(typeof DEMO_WORKBENCH_GRAPH_RESOURCE_LIST !== 'undefined' ? DEMO_WORKBENCH_GRAPH_RESOURCE_LIST : []);
          this.knowledgeResourceList = projectUsesEmptyWorkbenchResourceSeeds(nextProjectId)
            ? []
            : cloneRows(typeof DEMO_WORKBENCH_KNOWLEDGE_RESOURCE_LIST !== 'undefined' ? DEMO_WORKBENCH_KNOWLEDGE_RESOURCE_LIST : []);
