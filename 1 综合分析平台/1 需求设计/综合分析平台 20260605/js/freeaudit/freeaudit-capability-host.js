  ...
  const message = antd.message;
    ...
    app.component('FreeAuditCapabilityHost', {
      ...
      template: `<a-layout class="shell-main shell-main-flex-col freeaudit-view"><a-layout-content class="content-reset-flex-col">
          ...
          <header v-if="workbenchEmbedMode !== 'v2'" class="workbench-top-header workbench-top-header--unified workbench-top-header--project-detail">
          ...
          <div ref="mainBody" class="workbench-body">
            <teleport to="#workbench-v2-right-drawer-host" :disabled="embedMode !== 'v2'">
              <div
                v-if="embedMode === 'v2' && !workbenchV2RightDrawerCollapsed && workbenchV2RightPanel"
                class="workbench-v2-right-teleport-root"
              >
                ${freeauditPanels.workbenchV2RightPoolMarkup()}
              </div>
            </teleport>
            <aside v-if="workbenchEmbedMode !== 'v2'" class="workbench-rail workbench-rail--sources" :style="leftWorkbenchRailStyle">
              <div
              ...
              >
                ...
                <div v-if="sourcesLeftView === 'list'" class="nlm-side-panel-body">
                  <template v-if="workbenchLeftPrimaryTab === 'material' && workbenchEmbedMode !== 'v2'">
                  ${freeauditPanels.workbenchResourcePoolStack()}
                  </template>
                  </template>
                  <template v-else>
            ...
            <div v-if="workbenchEmbedMode !== 'v2'" class="nlm-resizer" :class="{ 'is-hidden': sourcesCollapsed }" @mousedown="beginResize('sources', $event)"></div>
            <section class="nlm-assistant-column" :style="{ flex: layoutMode === 'B' ? 4 : layoutRatios.middle, minWidth: 0, minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }">
              <div v-if="workbenchEmbedMode !== 'v2'" class="nlm-panel-header">
            ...
            <div v-if="workbenchEmbedMode !== 'v2'" class="nlm-resizer" :class="{ 'is-hidden': studioCollapsed }" @mousedown="beginResize('studio', $event)"></div>
            <teleport to="#workbench-v2-detail-host" :disabled="embedMode !== 'v2'">
                ...
                <div v-if="sourcesRightView === 'detail'" class="nlm-side-panel-body is-analysis-detail-open" style="display:flex;flex-direction:column;min-height:0;">
                  ...
                  >
                    ...
                    <div class="tc-skill-modal-body tc-skill-modal-body--unified material-preview-unified-body workbench-material-preview-unified-body">
                      <a-tabs v-model:activeKey="resourcePreviewTab" class="skill-unified-modal-tabs material-preview-unified-tabs workbench-embed-top-tabs" tab-position="top">
                        <a-tab-pane key="basic" tab="基本信息">
                          <FreeAuditBasicInfoPane :rows="resourcePreviewBasicMetaRows" key-prefix="v2-resource-preview-meta" hide-chrome />
                        </a-tab-pane>
                        <a-tab-pane v-if="selectedResourcePreview.type === 'database'" key="schema" tab="字段信息">
                          <div class="ds-unified-tab-pane-stack">
                            <div class="preview-modal-content-frame preview-modal-content-frame--material">
                  ...
                  >
                    ...
                    <template v-if="selectedMaterial && selectedMaterial.type === 'raw' && selectedMaterial.projectSource && workbenchSelectedProjectMaterialRow">
                      <div class="tc-skill-modal-body tc-skill-modal-body--unified material-preview-unified-body workbench-material-preview-unified-body">
                        ...
                        >
                          <a-tab-pane key="basic" tab="基本信息">
                            <FreeAuditBasicInfoPane :rows="workbenchMaterialPreviewBasicMetaRows" key-prefix="v2-wbmeta" hide-chrome />
                          </a-tab-pane>
                          <a-tab-pane key="preview" tab="文件预览">
                            <div class="preview-modal-content-frame preview-modal-content-frame--material">
                              <div class="material-preview-modal__viewer">
