...
/** 工作台级分析技能（工作台与审计助手共享，新增技能在两端同步可见） */
    const demoProjectAnalysisTemplatesById = Vue.reactive({
      'PRJ-2026-001': [
        ...
        {
          id: 'sk-prj-general-001',
          library: 'project',
          name: '审计问题要点归纳',
          skillKind: 'general',
          description: '将对话、资料摘录与已有结果整理为问题背景、关键事实和待核查事项。',
          tags: ['归纳', '问题梳理'],
          auditScene: 'finance',
          skillType: 'summary',
          skillInputs: ['对话记录', '资料摘录', '分析结果'],
          outputSummary: '输出问题要点、事实依据、待补充资料和下一步核查建议。',
          generalConfigInstruction: '围绕当前审计问题，先提炼背景与关键事实，再列出证据来源、缺口和后续核查动作；输出保持条目化，避免直接下结论。',
          createdBy: '我',
          ownerOrg: '审计管理组',
          updatedAt: '2026-06-12 10:20',
        },
        {
          id: 'sk-prj-general-002',
          library: 'project',
          name: '整改回复材料初稿生成',
          skillKind: 'general',
          description: '根据问题描述、责任单位反馈和附件依据生成整改回复初稿。',
          tags: ['整改', '材料生成'],
          auditScene: 'construction',
          skillType: 'writing',
          skillInputs: ['问题描述', '整改反馈', '附件依据'],
          outputSummary: '输出整改情况说明、佐证材料清单和仍需补充的内容。',
          generalConfigInstruction: '按整改事项逐条组织内容，包含问题概述、整改动作、完成情况、附件依据和遗留风险；措辞保持正式、克制，不编造不存在的整改结果。',
          createdBy: '我',
          ownerOrg: '审计管理组',
