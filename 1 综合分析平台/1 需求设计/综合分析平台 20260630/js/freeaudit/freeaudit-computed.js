(function () {
  ...
  NS.computed = {
        ...
        wbProjectSkillKindOptions() {
          return [
            {
              id: 'audit',
              label: '审计技能',
              description: '先提取关键信息，再进行审计分析',
            },
            {
              id: 'general',
              label: '通用技能',
              description: '基于行业标准的自定义配置',
            },
          ];
        },
        wbProjectSkillDimensionFieldLabel() {
          return '能力分类';
        },
        wbProjectSkillConfigIsGeneral() {
          return this.normalizeWbProjectSkillKind(this.wbDetailSelectedSkill) === 'general';
        },
        wbProjectSkillConfigIsAudit() {
          return !this.wbProjectSkillConfigIsGeneral;
        },
