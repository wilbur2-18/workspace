(function () {
  ...
  function materialActionSet(status) {
    ...
    if (st === 'queued') {
      return {
        primary: ['abort'],
        more: ['detail', 'ref', 'download', 'rename', 'delete'],
        context: ['detail', 'abort', 'ref', 'download', 'rename', 'delete'],
    ...
    if (st === 'parsing') {
      return {
        primary: ['ref'],
        more: ['detail', 'abort', 'download', 'rename', 'delete'],
        context: ['detail', 'ref', 'abort', 'download', 'rename', 'delete'],
        bulk: ['ref', 'download', 'abort', 'delete'],
      };
    }
    if (st === 'failed') {
      return {
        primary: ['rerun'],
        more: ['detail', 'ref', 'download', 'rename', 'delete'],
        context: ['detail', 'rerun', 'ref', 'download', 'rename', 'delete'],
        bulk: ['ref', 'download', 'rerun', 'delete'],
      };
    }
    return {
      primary: ['ref'],
      more: ['detail', 'rerun', 'download', 'rename', 'delete'],
      context: ['detail', 'ref', 'rerun', 'download', 'rename', 'delete'],
      bulk: ['ref', 'download', 'rerun', 'delete'],
    };
  }
