(function () {
  ...
  const DEFAULT_PROJECT_LIST = [
    { id: 'PRJ-2026-001', name: 'A市城建集团年度经济责任审计', description: '展示完整审计分析流程。', createdBy: '李审计', createdAt: '2026-06-03 09:20', updatedAt: '2026-06-05 14:30' },
    { id: 'PRJ-2026-002', name: '模型繁忙与排队反馈', description: '进入后自动展示模型请求排队、等待与生成中反馈。', createdBy: '韩分析', createdAt: '2026-06-02 16:10', updatedAt: '2026-06-05 11:12' },
    { id: 'PRJ-2026-003', name: '工具调用授权确认', description: '进入后自动展示删除结果前的授权确认与审批状态。', createdBy: '赵管理员', createdAt: '2026-06-01 10:08', updatedAt: '2026-06-04 18:05' },
    { id: 'PRJ-2026-004', name: '空白对话起步', description: '进入后展示已添加资源下的初始化引导，便于演示首次对话入口。', createdBy: '王审计', createdAt: '2026-05-30 15:45', updatedAt: '2026-06-03 09:26' },
  ];
    ...
    methods: {
      ...
      saveProjectEdit() {
        ...
        if (i >= 0) {
          ...
          this.projectList.splice(i, 1, { ...this.projectList[i], name, description: desc, updatedAt });
        ...
        try {
          ...
          if (!exists) {
            this.projectList.push({
              ...
              createdBy: parsed.createdBy || '审计员01',
