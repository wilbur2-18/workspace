...
- `scripts/audit-token-coverage.mjs` should keep `should-fix=0`; remaining `review` items are acceptable only when they are layout, graph geometry, line-height, or intentionally strong emphasis cases.
